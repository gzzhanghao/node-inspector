...
DebugServer.prototype._createSession = function(debugPort, wsConnection) {
  this._config.debuggerPort = debugPort;
  this._config.debuggerCloseTimeout = 100;
  this._config.plugins = [{
    commands: require('./commands/NativeCommand'),
    events: require('./events/NativeEvent')
  }, {
    commands: require('./commands/DebuggerCommand'),
    injection: require.resolve('./injections/DebuggerInjection')
  }, {
    commands: require('./commands/RuntimeCommand'),
    injection: require.resolve('./injections/RuntimeInjection')
  }, {
    commands: require('./commands/PageCommand')
  }, {
    injection: require.resolve('./injections/ConsoleInjection')
  }];
  return new Session(wsConnection, this._config);
};
